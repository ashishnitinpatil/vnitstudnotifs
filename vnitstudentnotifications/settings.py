# Django settings for vnitstudentnotifications project.
...
ROOT_URLCONF = 'vnitstudentnotifications.urls'
...
INSTALLED_APPS = (
    ...
    'vnitstudentnotifications.coreapp',
